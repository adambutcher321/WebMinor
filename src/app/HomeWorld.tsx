...
const SECTIONS = [
  {
    ...
    body: 'Hosting is £50 a month plus VAT. That gets you a home page, a contact page and an about page, usually live within seven working days of getting your words and photos.',
    tags: [] as string[],
  },
  {
...
/*
  `reviews` is a server component (it fetches from Google with a secret key), so
  it can't be imported here. The server page renders it and hands it in.
*/
export default function HomeWorld({ reviews }: { reviews?: ReactNode }) {
